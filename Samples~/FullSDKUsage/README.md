...
5. Inspector에서 필요 시 조정: `remoteConfigKey`, `functionName`, `chatChannelId`, (선택) `googleIdTokenForLinkOrSignIn`  

## 주의

- RemoteConfig `value_json`은 **엄격 모드**: 객체 루트 JSON(`{...}`)만 허용됩니다.  
- Edge Function JWT/권한은 프로젝트 설정에 따라 추가 조정이 필요할 수 있습니다.  
