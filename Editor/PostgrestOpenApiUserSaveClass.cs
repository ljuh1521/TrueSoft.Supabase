...
namespace Truesoft.Supabase.Editor
{
    ...
    internal static class PostgrestOpenApiUserSaveClass
    {
            ...
            IReadOnlyList<OpenApiColumn> columns)
        {
            ...
            sb.AppendLine(indent + "    {");
            sb.AppendLine(indent + "        EnsureRegistered();");
            sb.AppendLine(indent + "        var loaded = await global::Truesoft.Supabase.Unity.Supabase.TryLoadUserSaveAttributedAsync<" + rowTypeName + ">(defaultValue: null, includeUpdatedAt: includeUpdatedAt);");
